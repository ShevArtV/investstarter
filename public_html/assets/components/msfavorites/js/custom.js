    ...
    msFavorites.prototype = {
        ...
        loadFavorites: function (again) {
            ...
            $($.fn.msfavorites.selectors.main).each(function (idx, el) {
                var $el = $(el), _id = $el.data('data-id') || '', _list = $el.data('data-list') || 'default', _type = $el.data('data-type') || 'resource',
                    _key = $el.data('data-key') || '';
...
$(document).on('msfavorites:process-action.msfavorites', function (e, data) {
    ...
    if (data.method == 'add' && $('.favorites_banner').length) {
        $('.favorites_banner').addClass('clickstar');
        $('.favorites_banner').addClass('active');
    }
    console.log(data);
});
$(document).ready(function(){
    if($('#favorites_banner .js-close-btn').length){
        $('#favorites_banner .js-close-btn').on('click', () =>   $('.favorites_banner').removeClass('active'));
    }
});
